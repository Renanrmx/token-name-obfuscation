...
export default class ObfuscatorToken {
    ...
    async setState(state) {
        ...
        if (this._token.actor.hasPlayerOwner && !Settings.allowPlayerOwned) {
            return;
        }
...
function getNameWithAffixes(actualName, expectedName, newName) {
    if (Settings.allowPreserveAffixes && actualName.includes(expectedName)) {
