export default class Settings {
    ...
    static get keepDuplicatesInSync() {
        return game.settings.get("token-name-obfuscation", "keepDuplicatesInSync");
    }
    ...
    static register() {
        ...
        game.settings.register("token-name-obfuscation", "keepDuplicatesInSync", {
            name: game.i18n.localize("tno.keepDuplicatesInSync.name"),
            hint: game.i18n.localize("tno.keepDuplicatesInSync.hint"),
            scope: "world",
            config: true,
            default: false,
            type: Boolean,
